...
<body>
  ...
  <div class="site-wrap">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg btn-block" onclick="window.location='{{ route('thankyou') }}'">Place
                      Order</button>
                  </div>
    ...
    <div class="site-section bg-secondary bg-image" style="background-image: url('images/bg_2.webp');">
      <div class="container">
