...
.dropdown-menu {
  ...
  --bs-dropdown-link-active-bg: #2a5555;
...
.nav-pills {
  ...
  --bs-nav-pills-link-active-bg: #2a5555;
}
.nav-pills .nav-link {
  background: none;
  border: 0;
...
.accordion {
  ...
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23264d4d'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-focus-border-color: #95aaaa;
  --bs-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(42, 85, 85, 0.25);
  --bs-accordion-body-padding-x: 1.25rem;
  --bs-accordion-body-padding-y: 1rem;
  --bs-accordion-active-color: #264d4d;
  --bs-accordion-active-bg: #eaeeee;
}
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(42, 85, 85, 0.25);
  --bs-pagination-active-color: #fff;
  --bs-pagination-active-bg: #2a5555;
  --bs-pagination-active-border-color: #2a5555;
...
.alert-primary {
  --bs-alert-color: #193333;
  --bs-alert-bg: #d4dddd;
  --bs-alert-border-color: #bfcccc;
}
...
.list-group {
  ...
  --bs-list-group-active-bg: #2a5555;
  --bs-list-group-active-border-color: #2a5555;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
...
.text-bg-primary {
  color: #fff !important;
  background-color: RGBA(42, 85, 85, var(--bs-bg-opacity, 1)) !important;
}
